...
Here we will use an Arizona State Plane, Central (ft, EPSG:2223), which is appropriate for Maricopa county, AZ. For future projects discuss appropriate data projections with your project lead or GIS manager. See https://epsg.io/ to query EPSG codes for your desired projection.
